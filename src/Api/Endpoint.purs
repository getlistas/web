-- | Doneq uses a REST API for resource management. This module defines endpoints in a data type
...
-- |
-- | This module takes the same approach as the `Doneq.Data.Route` module. For a more in-depth
...
import Doneq.Data.Comment (CommentId)
import Doneq.Data.Route (slug, uname)
